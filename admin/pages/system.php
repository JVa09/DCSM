...
<main class="main-content">
    ...
    <div class="settings-grid">
        ...
        <div class="settings-card" id="generalCard">
            ...
            <div class="locked-overlay">
                ...
                <div class="lock-sub">Only Superadministrators can modify system configuration.</div>
            </div>
            <?php endif; ?>
        ...
        <div class="settings-card" id="advancedCard">
            ...
            <div class="locked-overlay">
                <i class="fas fa-lock"></i>
                <div class="lock-title">Superadmin Access Required</div>
                <div class="lock-sub">Only Superadministrators can modify advanced settings.</div>
            </div>
            <?php endif; ?>
            ...
            <div class="card-body">
                ...
                <div class="fg">
                    <label>PHP Upload Limit <span style="font-size:.65rem; color:#94a3b8; text-transform:none; letter-spacing:0;">— server-configured</span></label>
                    <div class="input-wrap">
                        <i class="fas fa-upload icon"></i>
                        <input type="text" value="<?= htmlspecialchars($upload_max) ?>" disabled>
                    </div>
                </div>

                <div class="fg">
                    <label>Memory Limit <span style="font-size:.65rem; color:#94a3b8; text-transform:none; letter-spacing:0;">— server-configured</span></label>
                    <div class="input-wrap">
                        <i class="fas fa-memory icon"></i>
                        <input type="text" value="<?= htmlspecialchars($memory_limit) ?>" disabled>
                    </div>
                </div>
    ...
    <div class="settings-card" style="margin-bottom:24px;">
        <div class="card-head">
            <div class="card-head-left">
                <div class="card-head-icon ci-teal"><i class="fas fa-heart-pulse"></i></div>
                <div>
                    <div class="card-head-title">System Health</div>
                    <div class="card-head-sub">Live server and environment diagnostics</div>
                </div>
            </div>
        </div>
        <div class="health-grid">
            <div class="health-item">
                <div class="hi-icon ci-blue"><i class="fas fa-code"></i></div>
                <div class="hi-body">
                    <div class="hi-label">PHP Version</div>
                    <div class="hi-value"><?= htmlspecialchars($php_version) ?></div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> Supported</div>
                </div>
            </div>
            <div class="health-item">
                <div class="hi-icon ci-green"><i class="fas fa-database"></i></div>
                <div class="hi-body">
                    <div class="hi-label">Database</div>
                    <div class="hi-value">MySQLi</div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> <?= $db_status ?></div>
                </div>
            </div>
            <div class="health-item">
                <div class="hi-icon ci-violet"><i class="fas fa-memory"></i></div>
                <div class="hi-body">
                    <div class="hi-label">Memory Limit</div>
                    <div class="hi-value"><?= htmlspecialchars($memory_limit) ?></div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> Available</div>
                </div>
            </div>
            <div class="health-item">
                <div class="hi-icon ci-amber"><i class="fas fa-upload"></i></div>
                <div class="hi-body">
                    <div class="hi-label">Max Upload Size</div>
                    <div class="hi-value"><?= htmlspecialchars($upload_max) ?></div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> Configured</div>
                </div>
            </div>
            <div class="health-item">
                <div class="hi-icon ci-teal"><i class="fas fa-stopwatch"></i></div>
                <div class="hi-body">
                    <div class="hi-label">Max Execution Time</div>
                    <div class="hi-value"><?= htmlspecialchars($max_exec) ?></div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> Configured</div>
                </div>
            </div>
            <div class="health-item">
                <div class="hi-icon ci-blue"><i class="fas fa-clock"></i></div>
                <div class="hi-body">
                    <div class="hi-label">Server Time</div>
                    <div class="hi-value" style="font-size:.8rem;"><?= date('M d, Y') ?></div>
                    <div class="hi-status hs-ok"><i class="fas fa-circle-check"></i> <?= date('h:i A') ?></div>
                </div>
            </div>
        </div>
    </div>
