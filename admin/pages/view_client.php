...
/* --- MATH --- */
$sqd_keys = ['sqd1', 'sqd2', 'sqd3', 'sqd4', 'sqd5', 'sqd6', 'sqd7', 'sqd8'];
$sqd_sum = 0;
        ...
        <div class="grid-layout">
            <div class="left-col">
                ...
                <div class="card">
                    ...
                    <div class="sqd-list">
                        <?php 
                        $labels = ["sqd1"=>"Responsiveness", "sqd2"=>"Reliability", "sqd3"=>"Access/Facilities", "sqd4"=>"Communication", "sqd5"=>"Costs", "sqd6"=>"Integrity", "sqd7"=>"Assurance", "sqd8"=>"Outcome"];
