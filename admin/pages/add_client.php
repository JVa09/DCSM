            ...
            <div class="card-body step-section" id="step2">
                ...
                <div class="cc-block">
                    ...
                    <div class="cc-opts">
                        ...
                        <div class="cc-opt">
                            ...
                            <label for="cc1_1">I know what a CC is and I saw this office's CC</label>
                        </div>
                        <div class="cc-opt">
                            <input type="radio" name="cc1" id="cc1_2" value="2">
                            <label for="cc1_2">I know what a CC is but I did NOT see this office's CC</label>
                        </div>
                        <div class="cc-opt">
                            <input type="radio" name="cc1" id="cc1_3" value="3">
                            <label for="cc1_3">I learned of the CC only when I saw this office's CC</label>
                        </div>
                        <div class="cc-opt">
                            <input type="radio" name="cc1" id="cc1_4" value="4">
                            <label for="cc1_4">I do not know what a CC is and I did not see one in this office <em>(N/A for CC2 &amp; CC3)</em></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="cc-block">
                    ...
                    <div class="cc-opts">
                        ...
                        <div class="cc-opt">
                            <input type="radio" name="cc2" id="cc2_0" value="0">
                            <label for="cc2_0">N/A</label>
                        </div>
                        <div class="cc-opt">
                ...
                <div class="cc-block">
                    ...
                    <div class="cc-opts">
                        ...
                        <div class="cc-opt">
                            <input type="radio" name="cc3" id="cc3_0" value="0">
                            <label for="cc3_0">N/A</label>
                        </div>
                        <div class="cc-opt">
