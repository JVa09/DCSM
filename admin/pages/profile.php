...
/* ========================= DATA FETCHING ========================= */
$profile_query = $conn->prepare("SELECT full_name, email, role, region, province, created_at FROM admin_users WHERE username = ?");
...
if (!empty($local_avatars)) {
    $avatar_url = "../../uploads/avatars/" . basename($local_avatars[0]);
} else {
    $avatar_url = "https://ui-avatars.com/api/?name=" . urlencode($display_name) . "&background=FCD116&color=002147&bold=true&size=200";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<main class="main-content">
    ...
    <div class="profile-hero">
        ...
        <div class="avatar-wrap" onclick="document.getElementById('avatarInput').click()" title="Click to change photo">
            <img id="heroAvatar" src="<?= $avatar_url ?>" class="hero-avatar" alt="Profile Photo">
        ...
        <div class="settings-card">
            ...
            <div class="card-body">
                ...
                <div style="display:flex; align-items:center; gap:14px; padding:14px 16px; background:#f8fafc; border-radius:var(--r-lg); border:1px solid var(--border); margin-bottom:22px; cursor:pointer;"
                    ...
                    <img id="cardAvatar" src="<?= $avatar_url ?>" style="width:48px;height:48px;border-radius:12px;object-fit:cover;border:2px solid rgba(0,56,168,.2);" alt="avatar">
                    <div style="flex:1;">
