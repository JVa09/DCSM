            ...
            <table>
                ...
                <?php if (mysqli_num_rows($result) > 0):
                    while ($row = mysqli_fetch_assoc($result)):
                        $row_avg = round(
                            (floatval($row['sqd0'])+floatval($row['sqd1'])+floatval($row['sqd2'])+
                             floatval($row['sqd3'])+floatval($row['sqd4'])+floatval($row['sqd5'])+
                             floatval($row['sqd6'])+floatval($row['sqd7'])+floatval($row['sqd8']))/9.0, 1);
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-btns">
                            ...
                            <a      class="btn-icon btn-icon-edit"   title="Edit"   href="edit_feedback.php?id=<?= $row['id'] ?>"><i class="fas fa-pen"></i></a>
